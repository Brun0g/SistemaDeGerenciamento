                        ...
                        <table id="table">
                            <thead >
                                <tr>
                                    ...
                                    <th style="border-right: 1px solid black;">Total por unidade</th>
                                </tr>
                            </thead>
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td style="width: 10%; color:green; border: 1px solid black;">R$ {{  number_format($value['preco_unidade'] * $value['quantidade'], 2, ",", ".")  }}</td>
                                    @endforeach
                                    @else
                                ...
                                <tr style = "border-top: black solid 1px; border-bottom: black solid 1px;">
                                    ...
                                    {{-- DUAS PORCENTAGEM PARA APLICAR --}}
                                    <td style="border: black solid 1px; color:indianred; ; border-top: hidden;">R$ {{  number_format($value['totalComDesconto'] / 100 * $porcentagem, 2, ",", ".") }}</td>
                                </tr>
                                <tr style = "border-top: black solid 1px; border-bottom: black solid 1px;">
                                    ...
                                    <td style="border: black solid 1px; color:green; border-top: hidden;">R$ {{  number_format($value['totalComDesconto'] - $value['totalComDesconto'] / 100 * $porcentagem, 2, ",", ".") }}</td>
                                </tr>
                            </table>
