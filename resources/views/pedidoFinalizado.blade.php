...
<div class="py-12">
                        ...
                        <table id="table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    @else
                                    <td style=" width: 10%; color:green; border: 1px solid black;">R$ {{  number_format($value['preco_unidade'], 2, ",", ".")}}
                                    </td>
                                    @endif --}}
                                    @if($value['porcentagem'] > 0)
                            ...
                            {{-- <div style="font-weight: 900; margin-top: 20px;"><span style="color: blue;">PP</span> - Preço promocional</div> --}}
  ...
  {{--                                       <td style="width: 5%; border: 1px solid black;">
                                        <span style="color: mediumblue; font-weight: 900; font-style:italic;">
                                            <span style="color: black; font-size: 14px;">(R${{number_format($value['preco_unidade'], 2, ",", ".")}} -{{$value['porcentagem']}}%)
                                            <span/>
                                        </span>
                                    </td> --}}