...
interface CarrinhoServiceInterface
{
	...
	function finalizarCarrinho($cliente_id, $endereco_id, $provider_carrinho, $provider_produto,  $provider_pedidos, $provider_promotions, $provider_entradas_saidas, $provider_user, $provider_registro);
